 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var e_;function Tb(){return e_||(e_=1,(function(s){function n(R,B){var Z=R.length;R.push(B);e:for(;0<Z;){var J=Z-1>>>1,oe=R[J];if(0<u(oe,B))R[J]=B,R[Z]=oe,Z=J;else break e}}function a(R){return R.length===0?null:R[0]}function r(R){if(R.length===0)return null;var B=R[0],Z=R.pop();if(Z!==B){R[0]=Z;e:for(var J=0,oe=R.length,b=oe>>>1;J<b;){var M=2*(J+1)-1,H=R[M],V=M+1,ne=R[V];if(0>u(H,Z))V<oe&&0>u(ne,H)?(R[J]=ne,R[V]=Z,J=V):(R[J]=H,R[M]=Z,J=M);else if(V<oe&&0>u(ne,Z))R[J]=ne,R[V]=Z,J=V;else break e}}return B}function u(R,B){var Z=R.sortIndex-B.sortIndex;return Z!==0?Z:R.id-B.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;s.unstable_now=function(){return d.now()}}else{var f=Date,m=f.now();s.unstable_now=function(){return f.now()-m}}var g=[],p=[],C=1,v=null,w=3,z=!1,U=!1,I=!1,se=!1,le=typeof setTimeout=="function"?setTimeout:null,ue=typeof clearTimeout=="function"?clearTimeout:null,de=typeof setImmediate<"u"?setImmediate:null;function ae(R){for(var B=a(p);B!==null;){if(B.callback===null)r(p);else if(B.startTime<=R)r(p),B.sortIndex=B.expirationTime,n(g,B);else break;B=a(p)}}function $(R){if(I=!1,ae(R),!U)if(a(g)!==null)U=!0,te||(te=!0,me());else{var B=a(p);B!==null&&P($,B.startTime-R)}}var te=!1,G=-1,K=5,q=-1;function X(){return se?!0:!(s.unstable_now()-q<K)}function Se(){if(se=!1,te){var R=s.unstable_now();q=R;var B=!0;try{e:{U=!1,I&&(I=!1,ue(G),G=-1),z=!0;var Z=w;try{t:{for(ae(R),v=a(g);v!==null&&!(v.expirationTime>R&&X());){var J=v.callback;if(typeof J=="function"){v.callback=null,w=v.priorityLevel;var oe=J(v.expirationTime<=R);if(R=s.unstable_now(),typeof oe=="function"){v.callback=oe,ae(R),B=!0;break t}v===a(g)&&r(g),ae(R)}else r(g);v=a(g)}if(v!==null)B=!0;else{var b=a(p);b!==null&&P($,b.startTime-R),B=!1}}break e}finally{v=null,w=Z,z=!1}B=void 0}}finally{B?me():te=!1}}}var me;if(typeof de=="function")me=function(){de(Se)};else if(typeof MessageChannel<"u"){var Ze=new MessageChannel,Ne=Ze.port2;Ze.port1.onmessage=Se,me=function(){Ne.postMessage(null)}}else me=function(){le(Se,0)};function P(R,B){G=le(function(){R(s.unstable_now())},B)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(R){R.callback=null},s.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<R?Math.floor(1e3/R):5},s.unstable_getCurrentPriorityLevel=function(){return w},s.unstable_next=function(R){switch(w){case 1:case 2:case 3:var B=3;break;default:B=w}var Z=w;w=B;try{return R()}finally{w=Z}},s.unstable_requestPaint=function(){se=!0},s.unstable_runWithPriority=function(R,B){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var Z=w;w=R;try{return B()}finally{w=Z}},s.unstable_scheduleCallback=function(R,B,Z){var J=s.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?J+Z:J):Z=J,R){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=Z+oe,R={id:C++,callback:B,priorityLevel:R,startTime:Z,expirationTime:oe,sortIndex:-1},Z>J?(R.sortIndex=Z,n(p,R),a(g)===null&&R===a(p)&&(I?(ue(G),G=-1):I=!0,P($,Z-J))):(R.sortIndex=oe,n(g,R),U||z||(U=!0,te||(te=!0,me()))),R},s.unstable_shouldYield=X,s.unstable_wrapCallback=function(R){var B=w;return function(){var Z=w;w=B;try{return R.apply(this,arguments)}finally{w=Z}}}})(jc)),jc}var t_;function Nb(){return t_||(t_=1,Dc.exports=Tb()),Dc.exports}var zc={exports:{}},pt={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eo{getCompare(){return this.compare.bind(this)}indexedValueChanged(n,a){const r=new pe(zs,n),u=new pe(zs,a);return this.compare(r,u)!==0}minPost(){return pe.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vS=Math.log(2);class bS{constructor(n){const a=d=>parseInt(Math.log(d)/vS,10),r=d=>parseInt(Array(d+1).join("1"),2);this.count=a(n+1),this.current_=this.count-1;const u=r(this.count);this.bits_=n+1&u}nextBitIsOne(){const n=!(this.bits_&1<<this.current_);return this.current_--,n}}const qr=function(s,n,a,r){s.sort(n);const u=function(g,p){const C=p-g;let v,w;if(C===0)return null;if(C===1)return v=s[g],w=a?a(v):v,new rt(w,v.node,rt.BLACK,null,null);{const z=parseInt(C/2,10)+g,U=u(g,z),I=u(z+1,p);return v=s[z],w=a?a(v):v,new rt(w,v.node,rt.BLACK,U,I)}},d=function(g){let p=null,C=null,v=s.length;const w=function(U,I){const se=v-U,le=v;v-=U;const ue=u(se+1,le),de=s[se],ae=a?a(de):de;z(new rt(ae,de.node,I,null,ue))},z=function(U){p?(p.left=U,p=U):(C=U,p=U)};for(let U=0;U<g.count;++U){const I=g.nextBitIsOne(),se=Math.pow(2,g.count-(U+1));I?w(se,rt.BLACK):(w(se,rt.BLACK),w(se,rt.RED))}return C},f=new bS(s.length),m=d(f);return new Tt(r||n,m)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class SS extends eo{constructor(n){super(),this.indexPath_=n,Y(!ve(n)&&he(n)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(n){return n.getChild(this.indexPath_)}isDefinedOn(n){return!n.getChild(this.indexPath_).isEmpty()}compare(n,a){const r=this.extractChild(n.node),u=this.extractChild(a.node),d=r.compareTo(u);return d===0?Hs(n.name,a.name):d}makePost(n,a){const r=ot(n),u=ie.EMPTY_NODE.updateChild(this.indexPath_,r);return new pe(a,u)}maxPost(){const n=ie.EMPTY_NODE.updateChild(this.indexPath_,ul);return new pe(Hi,n)}toString(){return t0(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ES extends eo{compare(n,a){const r=n.node.compareTo(a.node);return r===0?Hs(n.name,a.name):r}isDefinedOn(n){return!0}indexedValueChanged(n,a){return!n.equals(a)}minPost(){return pe.MIN}maxPost(){return pe.MAX}makePost(n,a){const r=ot(n);return new pe(a,r)}toString(){return".value"}}const wS=new ES;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gr(){return{value:null,children:new Map}}function c0(s,n,a){if(ve(n))s.value=a,s.children.clear();else if(s.value!==null)s.value=s.value.updateChild(n,a);else{const r=he(n);s.children.has(r)||s.children.set(r,Gr());const u=s.children.get(r);n=He(n),c0(u,n,a)}}function td(s,n,a){s.value!==null?a(n,s.value):OS(s,(r,u)=>{const d=new ke(n.toString()+"/"+r);td(u,d,a)})}function OS(s,n){s.children.forEach((a,r)=>{n(r,a)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tl{constructor(n,a,r){this.source=n,this.path=a,this.children=r,this.type=nn.MERGE}operationForChild(n){if(ve(this.path)){const a=this.children.subtree(new ke(n));return a.isEmpty()?null:a.value?new Bi(this.source,Te(),a.value):new tl(this.source,Te(),a)}else return Y(he(this.path)===n,"Can't get a merge for a child not on the path of the operation"),new tl(this.source,He(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Qc;const BS=()=>(Qc||(Qc=new Tt(SC)),Qc);class qe{static fromObject(n){let a=new qe(null);return At(n,(r,u)=>{a=a.set(new ke(r),u)}),a}constructor(n,a=BS()){this.value=n,this.children=a}isEmpty(){return this.value===null&&this.children.isEmpty()}findRootMostMatchingPathAndValue(n,a){if(this.value!=null&&a(this.value))return{path:Te(),value:this.value};if(ve(n))return null;{const r=he(n),u=this.children.get(r);if(u!==null){const d=u.findRootMostMatchingPathAndValue(He(n),a);return d!=null?{path:it(new ke(r),d.path),value:d.value}:null}else return null}}findRootMostValueAndPath(n){return this.findRootMostMatchingPathAndValue(n,()=>!0)}subtree(n){if(ve(n))return this;{const a=he(n),r=this.children.get(a);return r!==null?r.subtree(He(n)):new qe(null)}}set(n,a){if(ve(n))return new qe(a,this.children);{const r=he(n),d=(this.children.get(r)||new qe(null)).set(He(n),a),f=this.children.insert(r,d);return new qe(this.value,f)}}remove(n){if(ve(n))return this.children.isEmpty()?new qe(null):new qe(null,this.children);{const a=he(n),r=this.children.get(a);if(r){const u=r.remove(He(n));let d;return u.isEmpty()?d=this.children.remove(a):d=this.children.insert(a,u),this.value===null&&d.isEmpty()?new qe(null):new qe(this.value,d)}else return this}}get(n){if(ve(n))return this.value;{const a=he(n),r=this.children.get(a);return r?r.get(He(n)):null}}setTree(n,a){if(ve(n))return a;{const r=he(n),d=(this.children.get(r)||new qe(null)).setTree(He(n),a);let f;return d.isEmpty()?f=this.children.remove(r):f=this.children.insert(r,d),new qe(this.value,f)}}fold(n){return this.fold_(Te(),n)}fold_(n,a){const r={};return this.children.inorderTraversal((u,d)=>{r[u]=d.fold_(it(n,u),a)}),a(n,this.value,r)}findOnPath(n,a){return this.findOnPath_(n,Te(),a)}findOnPath_(n,a,r){const u=this.value?r(a,this.value):!1;if(u)return u;if(ve(n))return null;{const d=he(n),f=this.children.get(d);return f?f.findOnPath_(He(n),it(a,d),r):null}}foreachOnPath(n,a){return this.foreachOnPath_(n,Te(),a)}foreachOnPath_(n,a,r){if(ve(n))return this;{this.value&&r(a,this.value);const u=he(n),d=this.children.get(u);return d?d.foreachOnPath_(He(n),it(a,u),r):new qe(null)}}foreach(n){this.foreach_(Te(),n)}foreach_(n,a){this.children.inorderTraversal((r,u)=>{u.foreach_(it(n,r),a)}),this.value&&a(n,this.value)}foreachChild(n){this.children.inorderTraversal((a,r)=>{r.value&&n(a,r.value)})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
